...
public class NovoGameAtualizado {
	...
	public static void main(String[] args) throws Exception {
		...
		case "b", "B":
			MENS("Você posiciona-se a frente do delator, saca a arma que\n"
			...
			MENS("Problema resolvido e a sua forma de solucionar a situação chamou a atenção dos mafiosos\n"
					+ "da região, os mesmos te convidaram para se tornar o Caporegime da família.\n",
					TimeUnit.MILLISECONDS, temp_quick);
