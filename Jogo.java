	...
	public static void capitulo3() throws Exception {
		...
		case "c":
			...
			MENS("Você chega até o ponto de encontro e discute o assunto com a máfia vizinha. \n"
					+ "",TimeUnit.MILLISECONDS,temp_quick);
			MENS("Seus negócios tem crescido bastante e isso está nos afetando, como oferta de negociação para evitar problemas"
					+ "maiores pra vocês,"
					+ " peço que você me dê quatorze cassinos estratégicos.\n"
					+ "O que me diz?" , TimeUnit.MILLISECONDS,temp_quick);
			
		
			MENS("Quatorze cassinos seriam o fim dos negócios do senhor Don, como eu estou neste momento representando-o, o"
					+ "que posso oferecer são cinco cassinos,\n"
			...
			MENS("“Eu aceito no mínimo dez, você acha que eu sou amador garoto? É isso ou nada feito.” ", TimeUnit.MILLISECONDS,temp_quick);
			...
			case "b":
				...
				MENS("Voltando para a casa dos Fibonacci, o senhor Don anseia em falar com você...", TimeUnit.MILLISECONDS,temp_quick);
				MENS( "Você está se saindo cada vez melhor,"
				...
				MENS("Não seja tão ambicioso, você já deve saber que o máximo que pode subir é até onde está,"
					+ " mais que isso eu teria que morrer!"+"\r\n", TimeUnit.MILLISECONDS,temp_quick);
				
				MENS("Sim senhor, me desculpe, que bobagem a minha não? \n", TimeUnit.MILLISECONDS,temp_quick);
				
				
				MENS("Você prepara um copo de whiskey com gelo para o Don, como de costume, só que antes de servi-lo coloca o veneno "
